# Mutsumi-s PRES — Brand Guidelines
...
| Name | Hex | Usage |
|------|-----|-------|
| Primary | `#3a5068` | Gradient start, CTA, accents |
| Secondary | `#5a7a8a` | Gradient end, hover states |
| Text (light bg) | `#c0d0e0` | Body text on white/light |
| Text (dark bg) | `#2a2a2a` | Body text on dark |
| Background (light) | `#f5f4f0` | Light mode |
| Background (dark) | `#0d0d0d` | Dark mode |
